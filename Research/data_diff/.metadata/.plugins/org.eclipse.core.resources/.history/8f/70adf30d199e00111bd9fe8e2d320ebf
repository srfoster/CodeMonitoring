...
public class SmartDiffer {
	...
	public static void main(String[] args)
	{
		...
		String dir_name = "output/"+name+".java/";
		...
		{
	    	String file_name1 = children[i];
	    	String file_name2 = children[i+1];
			try{
				differ.handleFile(dir_name + file_name1, dir_name + file_name2);
			}catch(Exception e){
				e.printStackTrace();
			}
		}
